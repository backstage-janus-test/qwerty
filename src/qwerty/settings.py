...
APP_NAME = os.getenv("APP_NAME", "qwerty")
...
MIDDLEWARE = [
    'qwerty.middleware.healthcheckmiddleware.HealthCheckMiddleware',
    ...
    'qwerty.middleware.metricsmiddleware.MetricsMiddleware',
]
...
REST_FRAMEWORK = {
    ...
    # TODO: implement our own authentication. RBAC or other thirdparty tool
